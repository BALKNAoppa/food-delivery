...
import { updateFood } from "../controller/foods/update-food.js";  // Import the new update function
...
foodRouter.put("/update/:id", authorizationMiddleware, updateFood);  // Use the correct update route with ID
